...
;;
;; Keybindings:
;;   m b - Create bookmark at current page
;;   m g - Access/navigate to (go to) bookmark
...
;; Using "m" prefix to avoid conflicts with existing pdf-tools keybindings
;; (B is used by pdf-history-backward, b might be used elsewhere)
(with-eval-after-load 'pdf-view
  (define-key pdf-view-mode-map (kbd "m b") #'pdf-bookmarks-create)
  (define-key pdf-view-mode-map (kbd "m g") #'pdf-bookmarks-access)
  (define-key pdf-view-mode-map (kbd "m d") #'pdf-bookmarks-delete))
