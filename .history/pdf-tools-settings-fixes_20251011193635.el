...
(with-eval-after-load 'pdf-view
  ...
  (define-key pdf-view-mode-map (kbd "C-c d") #'pdf-bookmarks-delete))


;;;; 10) Optional: Trim trailing whitespace on annot save -----------------------;; Comment this advice out to disable automatic whitespace trimming.
